...
| `type`          | `type`           |                                                                                                                              | `"color" \| "date" \| "daterange" \| "datetime" \| "email" \| "money" \| "number" \| "password" \| "phone" \| "search" \| "ssn" \| "text" \| "time" \| "url" \| ({ formatter: (str: string) => string; extractor?: (str: string) => string; masker?: (rawValue: string, formattedValue: string) => string; })` | `'text'`    |
